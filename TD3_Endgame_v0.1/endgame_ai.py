...
class ReplayBuffer(object):
    ...
    def sample(self,batch_size):
        ...
        for i in ind:
            ...
            print('shape of state while fecthing is', state.shape)
...
class Actor(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.layer_1 = nn.Conv2d(1,8,kernel_size=(3,3),padding=2) #28
        self.layer_2 = nn.Conv2d(8,16,kernel_size=(3,3),padding=2) #28
        self.layer_3 = nn.Conv2d(16,24,kernel_size=(3,3),stride=2) #14
        #self.layer_3 = nn.MaxPool2d(2,2) #10
        #self.layer_4 = nn.Conv2d(24,10,kernel_size=(1,1))
        self.layer_4 = nn.Conv2d(24,16,kernel_size=(3,3)) #14
        self.layer_5 = nn.Conv2d(16,8,kernel_size=(3,3)) #14
        self.layer_6 = nn.Conv2d(8,16,kernel_size=(3,3),stride=2) #7
        self.layer_7 = nn.Conv2d(16,10,kernel_size=(5,5)) #6
        #self.layer_7a = nn.AvgPool2d(16)
        #self.layer_6 =nn.Conv2d(32,10,kernel_size=(6,6))
        #self.layer_7u =nn.Linear(10,1000)
        self.layer_8 = nn.Linear(1200,30)
    ...
    def forward(self, x):
        ...
        x_orientation = [x[784],x[785]]
        x = x[0:784]
        x = torch.Tensor(x.reshape(-1,1,28,28))
        x_orientation = torch.Tensor(x.reshape(-1,1,1,2))
        #x=  x.view(-1,1,28,28)
        ...
        #x = F.relu(self.layer_7u(x))
        # print('AFTER shape{} and dim{}'.format(x.shape,x.dim()))
        x = F.relu(self.layer_8(x))
        x = self.max_action * torch.tanh(self.layer_9(x))
...
class Critic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.layer_6 = nn.Conv2d(8,16,kernel_size=(3,3),stride=2) #7
        self.layer_7 = nn.Conv2d(16,10,kernel_size=(5,5)) #6
        self.layer_8 = nn.Linear(1100,300)
        self.layer_9 = nn.Linear(300,action_dim)
        self.layer_8_q = nn.Linear(1001,300)
        
        self.layer_10 = nn.Conv2d(1,8,kernel_size=(3,3),padding=2) #28
        self.layer_11 = nn.Conv2d(8,16,kernel_size=(3,3),padding=2) #28
        self.layer_12 = nn.Conv2d(16,24,kernel_size=(3,3),stride=2) #14
        #self.layer_3 = nn.MaxPool2d(2,2) #10
        #self.layer_4 = nn.Conv2d(24,10,kernel_size=(1,1))
        self.layer_13 = nn.Conv2d(24,16,kernel_size=(3,3)) #14
        self.layer_14 = nn.Conv2d(16,8,kernel_size=(3,3)) #14
        self.layer_15 = nn.Conv2d(8,16,kernel_size=(3,3),stride=2) #7
        self.layer_16 = nn.Conv2d(16,10,kernel_size=(5,5)) #6
        self.layer_17 = nn.Linear(1100,300)
        self.layer_18 = nn.Linear(300,action_dim)
...
class TD3(object):
	...
	def select_action(self, state):
		print('shape of state here is', state.shape)
