...
class Actor(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.layer_1 = nn.Conv2d(3,8,kernel_size=(3,3)) #28
        ...
        self.layer_8 =nn.Linear(15,40)
        self.layer_8_1 =nn.Linear(1500,40)
    ...
    def forward(self,x):
        x_orientation = x[4800:4805]
        x = x[0:4800]
        x = torch.Tensor(x.reshape(-1,3,40,40))
...
class Critic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.bn_6 = nn.BatchNorm2d(16)
        self.layer_7 = nn.Conv2d(16,10,kernel_size=(5,5)) #6
        self.layer_8 = nn.Linear(1600,30)
        self.layer_9 = nn.Linear(30,action_dim)
        self.layer_8_1 = nn.Linear(1501,30)

        self.layer_10 = nn.Conv2d(3,8,kernel_size=(3,3)) #28
        ...
        self.layer_17 = nn.Linear(1600,30)
